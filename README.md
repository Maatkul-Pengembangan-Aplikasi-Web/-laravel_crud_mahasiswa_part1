...
### Setup Halaman Program Studi - Pencarian Data (search)
1. pada file `ProdiController.php` di folder app/http/controller update function class index
    ```
    ...
    ```
3. update file `index.blade.php` pada tombol search
    ```
    <x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
